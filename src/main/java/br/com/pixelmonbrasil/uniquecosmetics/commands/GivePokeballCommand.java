...
public class GivePokeballCommand {

    private CommandSpec commandSpec = CommandSpec.builder()
            .description(Text.of("Comando para entregar itens de mudança de pokébola."))
            .permission("uniquecosmetics.command.give.pokeball")
