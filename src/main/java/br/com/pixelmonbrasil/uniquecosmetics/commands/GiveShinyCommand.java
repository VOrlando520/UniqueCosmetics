...
public class GiveShinyCommand {

    private CommandSpec commandSpec = CommandSpec.builder()
            .description(Text.of("Comando para entregar itens de transformação shiny"))
            .permission("uniquecosmetics.command.give.shiny")
            ...
            .executor(new CommandExecutor() {
                ...
                public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
                    if(src instanceof Player || src instanceof ConsoleSource) {
                        ...
                        ItemStack itemStack = Config.getShinyTransformationItemStack().copy();
                        itemStack.setQuantity(quantity);
                        itemStack.offer(new MutableItemID("shinyTransformation"));
